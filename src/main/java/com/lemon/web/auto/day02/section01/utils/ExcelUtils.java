...
import com.lemon.web.auto.day02.section01.testcase.login.LoginSuccessData;
...
public class ExcelUtils {
	...
	public static void main(String[] args) throws Exception {
		ArrayList<Object> objs = readExcel("/testcase/login/login.xlsx", 1, LoginSuccessData.class);
